...
Image-based drug response profiling (DRP) of a patient-derived xenograft (PDX) quantified from an [OME-Zarr dataset](https://zenodo.org/records/18506825) using Fractal.
